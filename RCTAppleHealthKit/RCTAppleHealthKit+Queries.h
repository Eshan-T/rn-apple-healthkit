...
- (void)fetchSumOfSamplesOnDayForTypeHourly:(HKQuantityType *)quantityType unit:(HKUnit *)unit day:(NSDate *)day completion:(void (^)(NSArray *, NSDate *, NSDate *, NSError *))completionHandler;
